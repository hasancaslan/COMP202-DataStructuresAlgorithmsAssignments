...
public interface iBehavior {
    public boolean isWild(); // is it wild or not
    public void run(); // prints out "Running with ... speed"

    // Prints out "Zzz..."
    default void sleep(int sleepHours) throws ArithmeticException {
        if (sleepHours < 1) {
            throw new ArithmeticException("Cannot sleep less than 1 hour.");
        }
        String line = "Z";
